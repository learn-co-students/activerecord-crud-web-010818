...
def can_be_found_updated_and_saved
  ...
  current = Movie.find_by(title: "Awesome Flick")
  current.update(title: "Even Awesomer Flick")
  current.save
end
...
def can_update_using_update_method
  ...
  current = Movie.find_by(title: "Wat?")
  current.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  current = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  current.destroy
end
