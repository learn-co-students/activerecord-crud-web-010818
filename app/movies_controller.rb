...
def can_get_the_last_item_in_the_database
  Movie.last.title
  #go into last row of data and pull out title
  #nsdmsdl
   #dafndsf
   #alnk
end
...
def can_find_the_first_item_from_the_database_using_id
  #when find, use find. find choses id, findby other attribute
  #choose title because first item entirely
  Movie.find(1).title
end
...
def can_destroy_a_single_item #find by certain conditions
