...
def can_find_using_where_clause_and_be_sorted
  ...
  # release date descending
   ...
   Movie.all.select do |movieObj|
   movieObj.release_date >2002
 end.reverse
...
def can_update_multiple_items_at_once
  ...
  5.times do |i|
    Movie.create(title: "movie", release_date: 2000+i)
  end

  Movie.all.each do |movieObj|
    movieObj.update_attribute(:title, "A Movie")
end
end
